...
export default function MeetingCard({ teamName, name, resume, date, time, status }: MeetingCardProps) {
  ...
  return (
    <div className="min-w-72.5 w-72.5 px-3.75 py-3.25 shadow-md inset-shadow-xs rounded-lg bg-[#FBFAFF] border border-gray-200 hover:shadow-lg transition-shadow">

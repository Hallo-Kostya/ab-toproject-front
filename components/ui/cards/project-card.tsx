...
export default function ProjectCard({ name, description, teamsCnt, placesCnt }: ProjectCardProps) {
  ...
  return (
    <div className="flex flex-col w-full min-h-65 px-6 py-6 shadow-md inset-shadow-xs rounded-xl bg-[#FBFAFF] border border-gray-200 hover:shadow-lg transition-shadow">

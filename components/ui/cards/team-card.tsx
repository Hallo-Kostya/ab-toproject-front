...
export default function TeamCard({ id, name, teamNumber, studentCount }: TeamCardProps) {
  return (
    <div className="flex flex-col w-full max-h-[296px] px-[20px] py-[24px] shadow-md inset-shadow-xs rounded-[12px] bg-[#FBFAFF]">
      ...
      <div>
        ...
        <p className="text-gray-500 mt-2">Функционал отображения участников пока не реализован</p>
      </div>
    </div>
  );
}
...
export default function DeleteMeetingModal({ isOpen, onClose, meetingId, meetingName, onConfirm }: DeleteMeetingModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="p-6 bg-white rounded-[24px]">
        ...
        <h2 className="text-2xl text-[#000150] font-bold mb-2 text-center">Удалить встречу</h2>
        <p className="mb-6 text-center text-gray-600">
          Вы точно хотите удалить встречу <span className="font-semibold text-[#000150]">{meetingName}</span>?
        </p>

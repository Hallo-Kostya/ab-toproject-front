...
export default function DeleteTaskModal({ isOpen, onClose, taskId, taskDescription, onConfirm }: DeleteTaskModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="px-30">
      <div className="p-6 bg-white rounded-[24px]">
        ...
        <h2 className="text-2xl text-[#000150] font-bold mb-2 text-center">Удалить задачу</h2>
        <p className="mb-6 text-center text-gray-600">
          Вы точно хотите удалить задачу:<br/>
          <span className="font-semibold text-[#000150]">{taskDescription}</span>?
        </p>

...
export default function DeleteTeamModal({ isOpen, onClose, teamId, teamName }: DeleteTeamModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} className="px-30">
      <div className="p-6 bg-white rounded-[24px]">
        ...
        <h2 className="text-2xl text-[#000150] font-bold mb-2 text-center">Удалить команду</h2>
        <p className="mb-6 text-center text-gray-600">
          Вы точно хотите удалить команду <span className="font-semibold text-[#000150]">{teamName}</span>?
        </p>

...
export default function TaskFormModal({ isOpen, onClose, onAddTask }: TaskFormModalProps) {
    ...
    <Modal isOpen={isOpen} onClose={onClose}>
      <div className="p-6 bg-white rounded-[24px]">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="description" className="block mb-1 text-[16px] font-medium text-[#000150]">Описание задачи *</label>
            <textarea
              id="description"
              value={description}
